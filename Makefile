...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Sonar CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Sonar controllers
...
# This target prepares repo for your provider by replacing all "sonar"
